...
df1 %>% 
  ggplot +
    ...
    labs(title = "Total valve coaptation area indexed to orifice area") + 
    theme_bw() +
    theme(legend.position = "none",
          panel.grid = element_blank(),
          plot.title = element_text(hjust = 0.5))
ggsave("../figures/boxplotsTotalCoaptationArea.png", dpi = 300, units = "in")
ggsave("../figures/boxplotsTotalCoaptationArea.svg", dpi = 300, units = "in")
```
...
df1 %>% 
  ggplot +
    ...
    theme(legend.position = "none",
          panel.grid = element_blank(),
          plot.title = element_text(hjust = 0.5))
ggsave("../figures/violinplotsTotalCoaptationArea.png", dpi = 300, units = "in")
ggsave("../figures/violinplotsTotalCoaptationArea.svg", dpi = 300, units = "in")
```
...
df1 %>% 
  ggplot +
    ...
    theme(legend.position = "bottom",
          ...
          plot.title = element_text(hjust = 0.5))
ggsave("../figures/densityTotalCoaptationArea.png", dpi = 300, units = "in")
ggsave("../figures/densityTotalCoaptationArea.svg", dpi = 300, units = "in")
```
